...
public class AddStaffMemberCommandHandlerTests
{
    ...
    private static (Mock<IUnitOfWork> uow, Mock<IReadRepository<User>> userReadRepo, Mock<IWriteRepository<Assignment>> assignmentWriteRepo) Wire(
        IReadOnlyList<Assignment> callerAssignments, Branch? branch, User? existingUser, bool alreadyAssigned)
    {
        ...
        return (uow, userReadRepo, assignmentWriteRepo);
    }
    ...
    public async Task Handle_WhenCallerIsGymAdminOfTheBranchsCompany_AttachesTheExistingUserAsAssignment()
    {
        ...
        var (uow, _, assignmentWriteRepo) = Wire(callerAssignments, Branch1(), existingUser, alreadyAssigned: false);
        var smsSender = new Mock<ISmsSender>();
        var handler = new AddStaffMemberCommandHandler(uow.Object, smsSender.Object);
    ...
    public async Task Handle_WhenPhoneDoesNotBelongToAnyRegisteredUser_ThrowsNotFoundException()
    {
        ...
        var handler = new AddStaffMemberCommandHandler(uow.Object, Mock.Of<ISmsSender>());
