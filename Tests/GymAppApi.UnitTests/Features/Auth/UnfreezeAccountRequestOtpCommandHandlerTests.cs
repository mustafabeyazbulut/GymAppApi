...
public class UnfreezeAccountRequestOtpCommandHandlerTests
{
    ...
    public async Task Handle_WhenUserNotFound_ThrowsNotFoundException()
    {
        ...
        var handler = new UnfreezeAccountRequestOtpCommandHandler(uow.Object, sms.Object);

        await Assert.ThrowsAsync<NotFoundException>(() =>
            handler.Handle(new UnfreezeAccountRequestOtpCommand { UserId = 1 }, CancellationToken.None));
    }
    ...
    public async Task Handle_CreatesPendingPhoneCode_AndSendsSms()
    {
        ...
        await handler.Handle(new UnfreezeAccountRequestOtpCommand { UserId = 1 }, CancellationToken.None);
