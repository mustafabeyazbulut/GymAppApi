...
**Current status (2026-09-18): steps 1-3 done and pushed to `origin/main`.** Steps 4-6 not started, not designed. Check `docs/superpowers/plans/` for a `*-package-*` plan file before assuming otherwise — if the plan for a given step exists and shows tasks checked off, trust that over this summary.
