...
- [Tenant Onboarding progress](project-tenant-onboarding-progress.md) — DONE (11/11), plus an unplanned Company Management endpoint addition (list/detail/rename/activate).
